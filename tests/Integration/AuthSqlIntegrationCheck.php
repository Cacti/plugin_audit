 ...
 * database layer. The CI workflow enables auditing and seeds a user_log
 * row before invoking this file directly with `php` (not Pest); it is
 * named without a Test.php suffix so Pest's test discovery skips it.
 */

require dirname(__DIR__, 4) . '/include/cli_check.php';
