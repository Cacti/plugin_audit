 ...
 *
 * Several stubs also accept an optional test-supplied callable via
 * $GLOBALS['__test_<function name>'] so individual specs can inject
 * per-test dynamic behavior (e.g. return different rows for different
 * parameters) without redeclaring the global function themselves, which
 * would collide across test files sharing one PHP process.
 *
...
if (!function_exists('db_execute')) {
	function db_execute($sql) {
		...
		if (isset($GLOBALS['__test_db_execute']) && is_callable($GLOBALS['__test_db_execute'])) {
			return call_user_func($GLOBALS['__test_db_execute'], $sql);
		}
...
if (!function_exists('db_execute_prepared')) {
	function db_execute_prepared($sql, $params = array()) {
		...
		if (isset($GLOBALS['__test_db_execute_prepared']) && is_callable($GLOBALS['__test_db_execute_prepared'])) {
			return call_user_func($GLOBALS['__test_db_execute_prepared'], $sql, $params);
		}
...
if (!function_exists('db_fetch_assoc_prepared')) {
	function db_fetch_assoc_prepared($sql, $params = array()) {
		if (isset($GLOBALS['__test_db_fetch_assoc_prepared']) && is_callable($GLOBALS['__test_db_fetch_assoc_prepared'])) {
			return call_user_func($GLOBALS['__test_db_fetch_assoc_prepared'], $sql, $params);
		}
...
if (!function_exists('db_fetch_row_prepared')) {
	function db_fetch_row_prepared($sql, $params = array()) {
		if (isset($GLOBALS['__test_db_fetch_row_prepared']) && is_callable($GLOBALS['__test_db_fetch_row_prepared'])) {
			return call_user_func($GLOBALS['__test_db_fetch_row_prepared'], $sql, $params);
		}
...
if (!function_exists('db_fetch_cell_prepared')) {
	function db_fetch_cell_prepared($sql, $params = array()) {
		if (isset($GLOBALS['__test_db_fetch_cell_prepared']) && is_callable($GLOBALS['__test_db_fetch_cell_prepared'])) {
			return call_user_func($GLOBALS['__test_db_fetch_cell_prepared'], $sql, $params);
		}
...
if (!function_exists('db_table_exists')) {
	function db_table_exists($table) {
		if (isset($GLOBALS['__test_db_table_exists']) && is_callable($GLOBALS['__test_db_table_exists'])) {
			return call_user_func($GLOBALS['__test_db_table_exists'], $table);
		}
...
if (!function_exists('db_affected_rows')) {
	function db_affected_rows() {
		if (isset($GLOBALS['__test_db_affected_rows']) && is_callable($GLOBALS['__test_db_affected_rows'])) {
			return call_user_func($GLOBALS['__test_db_affected_rows']);
		}
...
if (!function_exists('api_plugin_user_realm_auth')) {
	function api_plugin_user_realm_auth($filename = '') {
		if (isset($GLOBALS['__test_api_plugin_user_realm_auth']) && is_callable($GLOBALS['__test_api_plugin_user_realm_auth'])) {
			return call_user_func($GLOBALS['__test_api_plugin_user_realm_auth'], $filename);
		}
...
if (!function_exists('read_config_option')) {
	function read_config_option($name, $force = false) {
		if (isset($GLOBALS['__test_read_config_option']) && is_callable($GLOBALS['__test_read_config_option'])) {
			return call_user_func($GLOBALS['__test_read_config_option'], $name);
		}
